...
//=====================left/right=========================
  ...
  function moveLeft() //undraw next and draw only if not on left edge or blocked
  { undraw()                                                                        //0
    ...
    // if an index is divisible by the width and it's remainder equals the width minus one.
//So in this case nine or 18 or 27 and so on the statement is true and we are at the right edge
    function moveRight() {
      undraw()  //9,18,27 etc because- row starts with 1,10,20 etc ends with 9,        //9
